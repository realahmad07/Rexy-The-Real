                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 space-y-4">
                      <div className="text-xs text-slate-500 text-justify leading-relaxed">
                        1. <strong>AI Limitations:</strong> While Rexy uses advanced Gemini 1.5 Pro models, AI audits are not a substitute for manual peer reviews. Use at your own risk.
                      </div>
                      <div className="text-xs text-slate-500 text-justify leading-relaxed">
